...
A huge benefit of Hoodie is not just that is is offline first, it also has a built in functionality to send notifications to other devices, when data is added, changed or removed. These are also tasks handed to the app client, when something changes.

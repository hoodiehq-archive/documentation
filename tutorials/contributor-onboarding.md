...
Hoodie is a quite big project and we have various parts that need to be created and / or maintained. To find out where we need help, take a look at our [Contribute Site](#). If you can't find anything you'd want to do or have further questions, please [contact us](#).
...
The easiest way to do this is a quick [Talky](http://talky.io), Skype call or Google Hangout with the person interested and at least one exsisiting contributer (this could be you already). If you happen to be in the same town, meeting for lunch, coffee or going on a walk is always the preferrable option.

### 2. Get Started together

1. Introduce them to our [Code of Conduct](#). Please do not just mention it but ask them to read it and ask whether they have questions or concerns. If so, please address them.
...
3. Depending on their skills and knowledge, introduce them to Hoodie-related terms and processes (see [The Hoodie Glossary](/hoodiehq/documentation/blob/gh-pages/glossary.md) and [FAQ](http://faq.hood.ie/) for more information).
...
In order to get started for real, the new controbutor of course needs access to the Hoodie software and repositories. Please make sure you only create accounts for the things they need access to in order to get their work done.
...
You should also add them to the the [team section](#) of our website and post a tweet about their addition to the team.
...
- If these are issues which are better not discussed with the group in the first place or if you not sure whether it's appropriate to bring them up in the community, please contact another community member first. This is especially applicable for all personal problems which may occur or topics related with the Code of Conduct. **For the latter, please ask the person who brought up the topic for their consensus to involve another person into addressing the issue first.**
  - [Lena](http://twitter.com/ffffux) and [Jan](http://twitter.com/janl) are also there to help you anytime.

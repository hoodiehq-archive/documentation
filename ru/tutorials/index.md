...
You should have [installed Hoodie and its prerequisites](/ru/start/) and read the [first part of this guide](/ru/start/getting-started/getting-started-1.html). We'll be looking at the Hoodie app you created in that.
